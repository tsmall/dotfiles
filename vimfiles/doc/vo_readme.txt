*vo_readme.txt*   VimOutliner 0.3.2 for Vim 6.1+       *vo* *vimoutliner*
...
RUNNING VIMOUTLINER                                          *vo-running*
    ...
    What are the comma comma commands                        *vo-command*
        ...
        Command list
            ...
            ,,H          reserved for manual de-hoisting (add-on)
            ,,h          reserved for hoisting (add-on)
            ,,1          set foldlevel=0
            ,,2          set foldlevel=1
            ,,3          set foldlevel=2
            ,,4          set foldlevel=3
    ...
    folder, what follows here are the "just the facts".
        ...
        Checkboxes                                          *vo-checkbox*
            ...
            ,,cb  Insert a check box on the current line or each line
                  ...
                  not aware of body text.
            ,,cx  Toggle check box state (percentage aware)
            ,,cd  Delete check boxes (percentage aware)
...
OTHER INFORMATION                                         *vo-other-info*
    ...
    The Vimoutliner Project
	    ...
	    for a few days or so to get the feel, then submit your
    ...
    Anticipated improvements in later versions
	    ...
	    Enable your $HOME/.vimoutlinerrc code to be designated as running
