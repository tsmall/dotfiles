...
Recently the team behind the Go programming language released [[https://blog.golang.org/go-fonts][their own fonts]].
One of them is a proportional font, and the other monospace. I immediately
liked both, and I've been using them as my main text editing fonts since then.

#+BEGIN_SRC elisp
  (trs/set-default-font "Go Mono" 140)
  (trs/set-variable-font "Go" 140)
#+END_SRC
