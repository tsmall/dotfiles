...
#+BEGIN_SRC elisp
  (trs/set-default-font "Noto Sans Mono" 140)
  (trs/set-variable-font "Noto Sans Display" 140)
#+END_SRC
...
#+begin_src elisp
  (setq elfeed-feeds/family
        (map 'list (lambda (url) (list url 'family))
...
#+begin_src elisp
  (setq elfeed-feeds/news-local
        (map 'list (lambda (url) (list url 'news 'local))
...
#+begin_src elisp
  (setq elfeed-feeds/news-national
        (map 'list (lambda (url) (list url 'news 'national))
             '("http://newsrss.bbc.co.uk/rss/newsonline_world_edition/front_page/rss.xml"
               "http://feeds.foxnews.com/foxnews/latest"
               "http://www.noonan.dns2go.com/content/rss/drudge.xml"
...
#+begin_src elisp
  (setq elfeed-feeds/random
        (map 'list (lambda (url) (list url 'random))
...
I split these up into two groups: "fast" and "slow" feeds.
...
#+begin_src elisp
  (setq elfeed-feeds/tech-fast
        (map 'list (lambda (url) (list url 'tech 'fast))
             '("http://om.co/feed/"
...
#+begin_src elisp
  (setq elfeed-feeds/tech-slow
        (map 'list (lambda (url) (list url 'tech 'slow))
             '("http://adactio.com/articles/rss"
               ...
               "http://blog.jetbrains.com/kotlin/feed/"
               ...
               "https://listed.standardnotes.org/@sn/feed.rss"
...
#+begin_src elisp
  (setq elfeed-feeds/tech-advent
        (map 'list (lambda (url) (list url 'tech 'advent))
