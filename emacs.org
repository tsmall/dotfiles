...
=eat= (Emulate A Terminal) is a big improvement over =shell= and =term=.
...
You also need to add this to your =.zshrc= file for tighter integration between
Eat, Emacs, and the shell.
...
Hyperbole is a suite of tools that add hypermedia features to Emacs.
