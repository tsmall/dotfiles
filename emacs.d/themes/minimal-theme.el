;;; minimal-theme.el --- Minimalistic Syntax Highlighting

;; Copyright (C) 2016 Tom Small III

;; Author: Tom Small III <tsmall3@gmail.com>
;; URL: http://github.com/tsmall/dotfiles
;; Package-Version: 20160320
;; Version: 1.0
...
;; A low districation light theme with minimal syntax highlighting. It only
;; highlights the minimal amount of things to be helpful.

;;; Credits:

;; This theme is forked from Marian Schubert's eink theme. You
;; can find that theme here: http://github.com/maio/eink-emacs

;;; Code:

(deftheme minimal
  "A theme with minimal syntax highlighting.")
...
(let ((fg "#111111")
  ...
  (custom-theme-set-faces
   ...
   `(mode-line-inactive ((t (:background ,bg-light :foreground ,fg-med :height 0.8))))
